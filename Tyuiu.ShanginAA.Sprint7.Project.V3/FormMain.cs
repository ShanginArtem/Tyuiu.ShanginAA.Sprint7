...
namespace Tyuiu.ShanginAA.Sprint7.Project.V3
{
    public partial class FormMain : Form
    {
        ...
        private void SetupChart()
        {
            ...
            chartPercent_SAA.Series.Add(new Series("Оценки")
            {
        ...
        private void buttonPercent_SAA_Click(object sender, EventArgs e)
        {
            ...
            chartPercent_SAA.Series["Оценки"].Points.Clear();

           
            foreach (var percentCount in percentCounts)
            {
                chartPercent_SAA.Series["Оценки"].Points.AddXY(percentCount.Key, percentCount.Value);
            }
        }
